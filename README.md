...
[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.22217970.svg)](https://doi.org/10.5281/zenodo.22217970)
...
<img width="1919" height="1074" alt="dashboard" src="https://github.com/user-attachments/assets/29c9b4bb-7522-41a7-8d0f-7d8465e3d0d7" />
...
@software{phiswarm2026,
  ...
  year   = {2026},
  url    = {https://doi.org/10.5281/zenodo.22217970},
  note   = {Software L0--L9 simulation framework. Penelope Inc. (PHI Lab).}
}
```

DOI: [10.5281/zenodo.22217970](https://doi.org/10.5281/zenodo.22217970) · Source: [github.com/Sm-bello/PHI-SWARM](https://github.com/Sm-bello/PHI-SWARM)
...
Public source of truth for the software framework. `v1.0.0` is tagged and
archived on Zenodo with a permanent DOI (above); every future tagged release
mints a new version under the same concept DOI.<img width="1919" height="1074" alt="dashboard" src="https://github.com/user-attachments/assets/eac6b2ad-d0ea-40fb-bdcf-4c62b400d499" />
